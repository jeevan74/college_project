...
import com.crrit.crrithandbook.databinding.ActivityDashboardStudentLp41Binding;
...
public class DashboardStudentActivitylp41 extends AppCompatActivity {

    private FirebaseAuth firebaseAuth;
    private ActivityDashboardStudentLp41Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDashboardStudentLp41Binding.inflate(getLayoutInflater());
    ...
    private void loadCategories() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //setup adapter
                adapterCategoryFacultyandStudentlp41 = new AdapterCategoryFacultyandStudentlp41(DashboardStudentActivitylp41.this,categoryArrayList);
