...
import com.crrit.crrithandbook.databinding.ActivityCategoryAddLp12Binding;
...
public class CategoryAddActivitylp12 extends AppCompatActivity {
    private ActivityCategoryAddLp12Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCategoryAddLp12Binding.inflate(getLayoutInflater());
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(CategoryAddActivitylp12.this,"Subject Added Successfully",Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //lab add failed
                        progressDialog.dismiss();
                        Toast.makeText(CategoryAddActivitylp12.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
