...
import com.crrit.crrithandbook.databinding.ActivityPdfAddLp41Binding;
...
public class PdfAddActivitylp41 extends AppCompatActivity {

    private ActivityPdfAddLp41Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfAddLp41Binding.inflate(getLayoutInflater());
        ...
        storageReference.putFile(pdfuri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(PdfAddActivitylp41.this, "PDF upload failed due to"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(PdfAddActivitylp41.this, "Successfully uploaded...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(PdfAddActivitylp41.this, "Failed to upload to db due to"+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
