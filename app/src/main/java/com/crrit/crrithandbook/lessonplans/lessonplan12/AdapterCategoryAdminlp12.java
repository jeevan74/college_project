...
public class AdapterCategoryAdminlp12 extends RecyclerView.Adapter<AdapterCategoryAdminlp12.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorylp12> categoryArrayList;
    ArrayList<ModelCategorylp12> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminlp12 filter;

    public AdapterCategoryAdminlp12(Context context, ArrayList<ModelCategorylp12> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorylp12 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitylp12.class);
    ...
    private void deleteCategory(ModelCategorylp12 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lessonplan12");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminlp12(filterList,this);
        }
        return filter;
    }
