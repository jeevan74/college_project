...
public class AdapterCategoryAdminlp41 extends RecyclerView.Adapter<AdapterCategoryAdminlp41.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorylp41> categoryArrayList;
    ArrayList<ModelCategorylp41> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminlp41 filter;

    public AdapterCategoryAdminlp41(Context context, ArrayList<ModelCategorylp41> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorylp41 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitylp41.class);
    ...
    private void deleteCategory(ModelCategorylp41 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lessonplan41");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminlp41(filterList,this);
        }
        return filter;
    }
