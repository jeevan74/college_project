...
public class AdapterCategoryAdminlp42 extends RecyclerView.Adapter<AdapterCategoryAdminlp42.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorylp42> categoryArrayList;
    ArrayList<ModelCategorylp42> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminlp42 filter;

    public AdapterCategoryAdminlp42(Context context, ArrayList<ModelCategorylp42> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorylp42 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitylp42.class);
    ...
    private void deleteCategory(ModelCategorylp42 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lessonplan42");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminlp42(filterList,this);
        }
        return filter;
    }
