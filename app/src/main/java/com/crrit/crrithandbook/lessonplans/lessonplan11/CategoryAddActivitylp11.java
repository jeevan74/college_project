...
import com.crrit.crrithandbook.databinding.ActivityCategoryAddLp11Binding;
...
public class CategoryAddActivitylp11 extends AppCompatActivity {
    private ActivityCategoryAddLp11Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCategoryAddLp11Binding.inflate(getLayoutInflater());
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(CategoryAddActivitylp11.this,"Subject Added Successfully",Toast.LENGTH_SHORT).show();
                    }
                })
