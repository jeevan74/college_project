...
public class AdapterCategoryAdminlp31 extends RecyclerView.Adapter<AdapterCategoryAdminlp31.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorylp31> categoryArrayList;
    ArrayList<ModelCategorylp31> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminlp31 filter;

    public AdapterCategoryAdminlp31(Context context, ArrayList<ModelCategorylp31> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorylp31 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitylp31.class);
    ...
    private void deleteCategory(ModelCategorylp31 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lessonplan31");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminlp31(filterList,this);
        }
        return filter;
    }
