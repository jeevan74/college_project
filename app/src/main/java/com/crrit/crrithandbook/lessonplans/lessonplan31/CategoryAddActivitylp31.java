...
import com.crrit.crrithandbook.databinding.ActivityCategoryAddLp31Binding;
...
public class CategoryAddActivitylp31 extends AppCompatActivity {
    private ActivityCategoryAddLp31Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCategoryAddLp31Binding.inflate(getLayoutInflater());
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(CategoryAddActivitylp31.this,"Lab Added Successfully",Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //lab add failed
                        progressDialog.dismiss();
                        Toast.makeText(CategoryAddActivitylp31.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
