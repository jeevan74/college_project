...
public class AdapterCategoryAdminlp21 extends RecyclerView.Adapter<AdapterCategoryAdminlp21.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorylp21> categoryArrayList;
    ArrayList<ModelCategorylp21> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminlp21 filter;

    public AdapterCategoryAdminlp21(Context context, ArrayList<ModelCategorylp21> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorylp21 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitylp21.class);
    ...
    private void deleteCategory(ModelCategorylp21 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lessonplan21");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminlp21(filterList,this);
        }
        return filter;
    }
