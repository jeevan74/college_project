...
import com.crrit.crrithandbook.databinding.ActivityDashboardStudentLp12Binding;
...
public class DashboardStudentActivitylp12 extends AppCompatActivity {

    private FirebaseAuth firebaseAuth;
    private ActivityDashboardStudentLp12Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDashboardStudentLp12Binding.inflate(getLayoutInflater());
    ...
    private void loadCategories() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //setup adapter
                adapterCategoryFacultyandStudentlp12 = new AdapterCategoryFacultyandStudentlp12(DashboardStudentActivitylp12.this,categoryArrayList);
