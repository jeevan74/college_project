...
import com.crrit.crrithandbook.databinding.ActivityPdfEditLp31Binding;
...
public class PdfEditActivitylp31 extends AppCompatActivity {

    private ActivityPdfEditLp31Binding binding;
    public String expId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfEditLp31Binding.inflate(getLayoutInflater());
        ...
        refExp.child(expId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        DatabaseReference refExp = FirebaseDatabase.getInstance().getReference("Lessonplan31");
        ...
        ref.child(expId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(PdfEditActivitylp31.this, "Info Updated...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(PdfEditActivitylp31.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
