...
public class AdapterCategoryAdminlp22 extends RecyclerView.Adapter<AdapterCategoryAdminlp22.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorylp22> categoryArrayList;
    ArrayList<ModelCategorylp22> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminlp22 filter;

    public AdapterCategoryAdminlp22(Context context, ArrayList<ModelCategorylp22> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorylp22 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitylp22.class);
    ...
    private void deleteCategory(ModelCategorylp22 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lessonplan22");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminlp22(filterList,this);
        }
        return filter;
    }
