...
public class CategoryAddActivitylp42 extends AppCompatActivity {
    private ActivityCategoryAddLp42Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCategoryAddLp42Binding.inflate(getLayoutInflater());
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(CategoryAddActivitylp42.this,"Subject Added Successfully",Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //lab add failed
                        progressDialog.dismiss();
                        Toast.makeText(CategoryAddActivitylp42.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
