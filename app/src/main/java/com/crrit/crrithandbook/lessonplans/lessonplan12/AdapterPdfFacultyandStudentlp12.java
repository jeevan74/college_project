...
public class AdapterPdfFacultyandStudentlp12 extends RecyclerView.Adapter<AdapterPdfFacultyandStudentlp12.HolderPdfAdmin>implements Filterable {//
    ...
    private FilterPdfFacultyandStudentlp12 filter;
    private static final String TAG ="PDF_ADAPTER_TAG";
    private final ProgressDialog progressDialog;

    //con
    public AdapterPdfFacultyandStudentlp12(Context context1, ArrayList<ModelPdflp12> pdfArrayList) {
...
//code is removed
    ...
    public Filter getFilter() {
        if (filter == null){
            filter = new FilterPdfFacultyandStudentlp12(filterlist,this);
        }
        return filter;
    }
