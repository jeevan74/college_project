...
public class AdapterCategoryAdminlp32 extends RecyclerView.Adapter<AdapterCategoryAdminlp32.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorylp32> categoryArrayList;
    ArrayList<ModelCategorylp32> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminlp32 filter;

    public AdapterCategoryAdminlp32(Context context, ArrayList<ModelCategorylp32> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorylp32 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitylp32.class);
    ...
    private void deleteCategory(ModelCategorylp32 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lessonplan32");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminlp32(filterList,this);
        }
        return filter;
    }
