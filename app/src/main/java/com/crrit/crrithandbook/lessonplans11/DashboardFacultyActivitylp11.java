...
import com.crrit.crrithandbook.databinding.ActivityDashboardFacultyActivitylp11Binding;
...
public class DashboardFacultyActivitylp11 extends AppCompatActivity {

    private FirebaseAuth firebaseAuth;
    private ActivityDashboardFacultyActivitylp11Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDashboardFacultyActivitylp11Binding.inflate(getLayoutInflater());
        ...
        binding.addCategoryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DashboardFacultyActivitylp11.this, CategoryAddActivitylp11.class));
            }
        });
        ...
        binding.addPdfFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DashboardFacultyActivitylp11.this, PdfAddActivitylp11.class));
            }
        });
    ...
    private void loadCategories() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //setup adapter
                adapterCategoryFacultyandStudentlp11 = new AdapterCategoryFacultyandStudentlp11(DashboardFacultyActivitylp11.this,categoryArrayList);
