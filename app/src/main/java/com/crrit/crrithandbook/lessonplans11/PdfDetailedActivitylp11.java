...
import com.crrit.crrithandbook.databinding.ActivityPdfDetailedActivitylp11Binding;
...
public class PdfDetailedActivitylp11 extends AppCompatActivity {

    private static final String TAG_DOWNLOAD = "DOWNLOAD_TAG";
    private ActivityPdfDetailedActivitylp11Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfDetailedActivitylp11Binding.inflate(getLayoutInflater());
        ...
        binding.rlclick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(PdfDetailedActivitylp11.this, PdfViewActivity.class);
        ...
        binding.downloadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(PdfDetailedActivitylp11.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    Log.d(TAG_DOWNLOAD, "onClick:Permission already granted can download pdf");
                    MyApplicationlp11.downloadPdf(PdfDetailedActivitylp11.this,""+expId,""+expTitle,""+expUrl);
                }
                else {
        ...
        reference.child(expId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        MyApplicationlp11.loadFromUrlSinglePage(""+expUrl,
                                ""+expTitle,
                                binding.pdfView,
                                binding.progressBar
                        );

                        MyApplicationlp11.loadSize(""+expUrl,
                                ""+expTitle,
                                binding.sizeTv
                        );
                        ...
                        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                            date = MyApplicationlp11.formatTimestamp(Long.parseLong(timestamp));
                        }
