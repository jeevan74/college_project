...
import com.crrit.crrithandbook.databinding.ActivityCategoryAddActivitym42Binding;
...
public class CategoryAddActivitym42 extends AppCompatActivity {
    private ActivityCategoryAddActivitym42Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCategoryAddActivitym42Binding.inflate(getLayoutInflater());
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(CategoryAddActivitym42.this,"Subject Added Successfully",Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //lab add failed
                        progressDialog.dismiss();
                        Toast.makeText(CategoryAddActivitym42.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
