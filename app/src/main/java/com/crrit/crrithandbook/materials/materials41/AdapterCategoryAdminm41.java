...
public class AdapterCategoryAdminm41 extends RecyclerView.Adapter<AdapterCategoryAdminm41.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorym41> categoryArrayList;
    ArrayList<ModelCategorym41> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminm41 filter;

    public AdapterCategoryAdminm41(Context context, ArrayList<ModelCategorym41> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorym41 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitym41.class);
    ...
    private void deleteCategory(ModelCategorym41 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Material41");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminm41(filterList,this);
        }
        return filter;
    }
