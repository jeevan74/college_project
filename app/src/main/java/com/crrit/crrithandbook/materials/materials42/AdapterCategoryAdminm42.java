...
public class AdapterCategoryAdminm42 extends RecyclerView.Adapter<AdapterCategoryAdminm42.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorym42> categoryArrayList;
    ArrayList<ModelCategorym42> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminm42 filter;

    public AdapterCategoryAdminm42(Context context, ArrayList<ModelCategorym42> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorym42 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitym42.class);
    ...
    private void deleteCategory(ModelCategorym42 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Material42");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminm42(filterList,this);
        }
        return filter;
    }
