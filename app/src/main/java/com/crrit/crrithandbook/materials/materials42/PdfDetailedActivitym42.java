...
import com.crrit.crrithandbook.databinding.ActivityPdfDetailedActivitym42Binding;
...
public class PdfDetailedActivitym42 extends AppCompatActivity {

    private static final String TAG_DOWNLOAD = "DOWNLOAD_TAG";
    private ActivityPdfDetailedActivitym42Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfDetailedActivitym42Binding.inflate(getLayoutInflater());
        ...
        binding.rlclick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(PdfDetailedActivitym42.this, PdfViewActivity.class);
        ...
        binding.downloadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(PdfDetailedActivitym42.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    Log.d(TAG_DOWNLOAD, "onClick:Permission already granted can download pdf");
                    MyApplicationm42.downloadPdf(PdfDetailedActivitym42.this,""+expId,""+expTitle,""+expUrl);
                }
                else {
        ...
        reference.child(expId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        MyApplicationm42.loadFromUrlSinglePage(""+expUrl,
                                ""+expTitle,
                                binding.pdfView,
                                binding.progressBar
                        );

                        MyApplicationm42.loadSize(""+expUrl,
                                ""+expTitle,
                                binding.sizeTv
                        );
                        ...
                        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                            date = MyApplicationm42.formatTimestamp(Long.parseLong(timestamp));
                        }
