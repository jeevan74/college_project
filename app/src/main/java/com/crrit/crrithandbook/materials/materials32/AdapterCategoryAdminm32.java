...
public class AdapterCategoryAdminm32 extends RecyclerView.Adapter<AdapterCategoryAdminm32.HolderCategory> implements Filterable {
    ...
    public AdapterCategoryAdminm32(Context context, ArrayList<ModelCategory> categoryArrayList) {
