...
public class AdapterCategoryAdminm31 extends RecyclerView.Adapter<AdapterCategoryAdminm31.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorym31> categoryArrayList;
    ArrayList<ModelCategorym31> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminm31 filter;

    public AdapterCategoryAdminm31(Context context, ArrayList<ModelCategorym31> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorym31 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitym31.class);
    ...
    private void deleteCategory(ModelCategorym31 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Material31");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminm31(filterList,this);
        }
        return filter;
    }
