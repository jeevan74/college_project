...
import com.crrit.crrithandbook.databinding.ActivityDashboardFacultyActivitym42Binding;
...
public class DashboardFacultyActivitym42 extends AppCompatActivity {

    private FirebaseAuth firebaseAuth;
    private ActivityDashboardFacultyActivitym42Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDashboardFacultyActivitym42Binding.inflate(getLayoutInflater());
        ...
        binding.addCategoryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DashboardFacultyActivitym42.this, CategoryAddActivitym42.class));
            }
        });
        ...
        binding.addPdfFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DashboardFacultyActivitym42.this, PdfAddActivitym42.class));
            }
        });
    ...
    private void loadCategories() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //setup adapter
                adapterCategoryFacultyandStudentm42 = new AdapterCategoryFacultyandStudentm42(DashboardFacultyActivitym42.this,categoryArrayList);
