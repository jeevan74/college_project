...
import com.crrit.crrithandbook.databinding.ActivityPdfEditActivitym12Binding;
...
public class PdfEditActivitym12 extends AppCompatActivity {

    private ActivityPdfEditActivitym12Binding binding;
    public String expId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfEditActivitym12Binding.inflate(getLayoutInflater());
        ...
        refExp.child(expId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        DatabaseReference refExp = FirebaseDatabase.getInstance().getReference("Materials12");
        ...
        ref.child(expId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(PdfEditActivitym12.this, "Info Updated...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(PdfEditActivitym12.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
