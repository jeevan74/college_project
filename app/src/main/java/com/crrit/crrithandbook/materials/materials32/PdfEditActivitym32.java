...
import com.crrit.crrithandbook.databinding.ActivityPdfEditActivitym32Binding;
...
public class PdfEditActivitym32 extends AppCompatActivity {

    private ActivityPdfEditActivitym32Binding binding;
    public String expId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfEditActivitym32Binding.inflate(getLayoutInflater());
        ...
        refExp.child(expId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        DatabaseReference refExp = FirebaseDatabase.getInstance().getReference("Material32");
        ...
        ref.child(expId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(PdfEditActivitym32.this, "Info Updated...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(PdfEditActivitym32.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
