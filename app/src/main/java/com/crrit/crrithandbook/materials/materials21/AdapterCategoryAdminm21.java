...
public class AdapterCategoryAdminm21 extends RecyclerView.Adapter<AdapterCategoryAdminm21.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorym21> categoryArrayList;
    ArrayList<ModelCategorym21> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminm21 filter;

    public AdapterCategoryAdminm21(Context context, ArrayList<ModelCategorym21> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorym21 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitym21.class);
    ...
    private void deleteCategory(ModelCategorym21 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Materials21");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminm21(filterList,this);
        }
        return filter;
    }
