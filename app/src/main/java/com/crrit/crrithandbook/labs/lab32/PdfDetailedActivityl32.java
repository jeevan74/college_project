...
public class PdfDetailedActivityl32 extends AppCompatActivity {

    private static final String TAG_DOWNLOAD = "DOWNLOAD_TAG";
    private ActivityPdfDetailedActivityl32Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfDetailedActivityl32Binding.inflate(getLayoutInflater());
        ...
        binding.rlclick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(PdfDetailedActivityl32.this, PdfViewActivity.class);
        ...
        binding.downloadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(PdfDetailedActivityl32.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    Log.d(TAG_DOWNLOAD, "onClick:Permission already granted can download pdf");
                    MyApplicationl32.downloadPdf(PdfDetailedActivityl32.this,""+expId,""+expTitle,""+expUrl);
                }
                else {
        ...
        reference.child(expId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        MyApplicationl32.loadCategory(
                                ""+categoryId,
                                binding.categoryTv
                        );

                        MyApplicationl32.loadFromUrlSinglePage(""+expUrl,
                                ""+expTitle,
                                binding.pdfView,
                                binding.progressBar
                        );

                        MyApplicationl32.loadSize(""+expUrl,
                                ""+expTitle,
                                binding.sizeTv
                        );
                        ...
                        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                            date = MyApplicationl32.formatTimestamp(Long.parseLong(timestamp));
                        }
