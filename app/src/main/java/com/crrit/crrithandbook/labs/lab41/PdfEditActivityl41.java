...
import com.crrit.crrithandbook.databinding.ActivityPdfEditActivityl41Binding;
...
public class PdfEditActivityl41 extends AppCompatActivity {

    private ActivityPdfEditActivityl41Binding binding;
    public String expId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfEditActivityl41Binding.inflate(getLayoutInflater());
        ...
        refExp.child(expId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        DatabaseReference refExp = FirebaseDatabase.getInstance().getReference("Lab41");
        ...
        ref.child(expId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(PdfEditActivityl41.this, "Info Updated...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(PdfEditActivityl41.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
