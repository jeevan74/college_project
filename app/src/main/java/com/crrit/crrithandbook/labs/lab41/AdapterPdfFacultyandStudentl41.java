...
public class AdapterPdfFacultyandStudentl41 extends RecyclerView.Adapter<AdapterPdfFacultyandStudentl41.HolderPdfAdmin>implements Filterable {//
    ...
    private FilterPdfFacultyandStudentl41 filter;
    private static final String TAG ="PDF_ADAPTER_TAG";
    private final ProgressDialog progressDialog;

    //con
    public AdapterPdfFacultyandStudentl41(Context context1, ArrayList<ModelPdfl41> pdfArrayList) {
...
//code is removed
    ...
    public Filter getFilter() {
        if (filter == null){
            filter = new FilterPdfFacultyandStudentl41(filterlist,this);
        }
        return filter;
    }
