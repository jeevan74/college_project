...
import com.crrit.crrithandbook.databinding.ActivityDashboardStudentActivityl21Binding;
...
public class DashboardStudentActivityl21 extends AppCompatActivity {

    private FirebaseAuth firebaseAuth;
    private ActivityDashboardStudentActivityl21Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDashboardStudentActivityl21Binding.inflate(getLayoutInflater());
    ...
    private void loadCategories() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //setup adapter
                adapterCategoryFacultyandStudentl21 = new AdapterCategoryFacultyandStudentl21(DashboardStudentActivityl21.this,categoryArrayList);
