...
import com.crrit.crrithandbook.databinding.ActivityPdfAddActivityl21Binding;
...
public class PdfAddActivityl21 extends AppCompatActivity {

    private ActivityPdfAddActivityl21Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfAddActivityl21Binding.inflate(getLayoutInflater());
        ...
        storageReference.putFile(pdfuri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(PdfAddActivityl21.this, "PDF upload failed due to"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(PdfAddActivityl21.this, "Successfully uploaded...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(PdfAddActivityl21.this, "Failed to upload to db due to"+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
