...
public class AdapterCategoryAdminl12 extends RecyclerView.Adapter<AdapterCategoryAdminl12.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategoryl12> categoryArrayList;
    ArrayList<ModelCategoryl12> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminl12 filter;

    public AdapterCategoryAdminl12(Context context, ArrayList<ModelCategoryl12> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategoryl12 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivityl12.class);
    ...
    private void deleteCategory(ModelCategoryl12 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lab12");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminl12(filterList,this);
        }
        return filter;
    }
