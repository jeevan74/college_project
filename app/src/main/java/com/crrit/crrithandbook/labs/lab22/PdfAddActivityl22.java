...
import com.crrit.crrithandbook.databinding.ActivityPdfAddActivityl22Binding;
...
public class PdfAddActivityl22 extends AppCompatActivity {

    private ActivityPdfAddActivityl22Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfAddActivityl22Binding.inflate(getLayoutInflater());
        ...
        storageReference.putFile(pdfuri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(PdfAddActivityl22.this, "PDF upload failed due to"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(PdfAddActivityl22.this, "Successfully uploaded...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(PdfAddActivityl22.this, "Failed to upload to db due to"+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
