...
import com.crrit.crrithandbook.databinding.ActivityDashboardFacultyActivityl32Binding;
...
public class DashboardFacultyActivityl32 extends AppCompatActivity {

    private FirebaseAuth firebaseAuth;
    private ActivityDashboardFacultyActivityl32Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDashboardFacultyActivityl32Binding.inflate(getLayoutInflater());
        ...
        binding.addCategoryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DashboardFacultyActivityl32.this, CategoryAddActivityl32.class));
            }
        });
        ...
        binding.addPdfFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DashboardFacultyActivityl32.this, PdfAddActivityl32.class));
            }
        });
    ...
    private void loadCategories() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //setup adapter
                adapterCategoryFacultyandStudentl32 = new AdapterCategoryFacultyandStudentl32(DashboardFacultyActivityl32.this,categoryArrayList);
