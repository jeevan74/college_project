...
public class AdapterCategoryAdminl41 extends RecyclerView.Adapter<AdapterCategoryAdminl41.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategoryl41> categoryArrayList;
    ArrayList<ModelCategoryl41> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminl41 filter;

    public AdapterCategoryAdminl41(Context context, ArrayList<ModelCategoryl41> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategoryl41 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivityl41.class);
    ...
    private void deleteCategory(ModelCategoryl41 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lab41");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminl41(filterList,this);
        }
        return filter;
    }
