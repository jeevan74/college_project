...
public class AdapterCategoryAdminl22 extends RecyclerView.Adapter<AdapterCategoryAdminl22.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategoryl22> categoryArrayList;
    ArrayList<ModelCategoryl22> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminl22 filter;

    public AdapterCategoryAdminl22(Context context, ArrayList<ModelCategoryl22> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategoryl22 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivityl22.class);
    ...
    private void deleteCategory(ModelCategoryl22 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lab22");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminl22(filterList,this);
        }
        return filter;
    }
