...
public class AdapterCategoryAdminl42 extends RecyclerView.Adapter<AdapterCategoryAdminl42.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategoryl42> categoryArrayList;
    ArrayList<ModelCategoryl42> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminl42 filter;

    public AdapterCategoryAdminl42(Context context, ArrayList<ModelCategoryl42> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategoryl42 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivityl42.class);
    ...
    private void deleteCategory(ModelCategoryl42 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lab42");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminl42(filterList,this);
        }
        return filter;
    }
