...
public class AdapterCategoryAdminl32 extends RecyclerView.Adapter<AdapterCategoryAdminl32.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategoryl32> categoryArrayList;
    ArrayList<ModelCategoryl32> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminl32 filter;

    public AdapterCategoryAdminl32(Context context, ArrayList<ModelCategoryl32> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategoryl32 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivityl32.class);
    ...
    private void deleteCategory(ModelCategoryl32 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lab32");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminl32(filterList,this);
        }
        return filter;
    }
