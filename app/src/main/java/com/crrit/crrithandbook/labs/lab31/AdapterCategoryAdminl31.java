...
public class AdapterCategoryAdminl31 extends RecyclerView.Adapter<AdapterCategoryAdminl31.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategoryl31> categoryArrayList;
    ArrayList<ModelCategoryl31> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminl31 filter;

    public AdapterCategoryAdminl31(Context context, ArrayList<ModelCategoryl31> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategoryl31 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivityl31.class);
    ...
    private void deleteCategory(ModelCategoryl31 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lab31");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminl31(filterList,this);
        }
        return filter;
    }
