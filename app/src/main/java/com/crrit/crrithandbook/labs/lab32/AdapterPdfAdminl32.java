...
public class AdapterPdfAdminl32 extends RecyclerView.Adapter<AdapterPdfAdminl32.HolderPdfAdmin> implements Filterable {//
    ...
    public void onBindViewHolder(@NonNull HolderPdfAdmin holder, int position) {
        ...
        //get&set data
        //get data
        ModelPdfl32 model = pdfArrayList.get(position);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
            date = MyApplicationl32.formatTimestamp(Long.parseLong(String.valueOf(timestamp)));
        }
        ...
        MyApplicationl32.loadFromUrlSinglePage(
                ""+pdfUrl,
                ""+title,
                holder.pdfView,
                holder.progressBar
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfDetailedActivityl32.class);
    ...
    private void moreOptionsDalog(ModelPdfl32 model, HolderPdfAdmin holder) {
        ...
        builder.setTitle("Choose Options")
                .setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (which==0){
                            //edit
                            Intent intent = new Intent(context, PdfEditActivityl32.class);
                            intent.putExtra("expId",expId);
                            context.startActivity(intent);
                        }
                        else if (which==1){
                            //delete
                            MyApplicationl32.deleteExp(
                                    context,
                                    ""+expId,
                                    ""+expUrl,
                                    ""+expTitle
...
//code is removed
    ...
    public Filter getFilter() {
        if (filter == null){
            filter = new FilterPdfAdminl32(filterlist,this);
        }
        return filter;
    }
