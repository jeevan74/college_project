...
public class AdapterCategoryAdminl21 extends RecyclerView.Adapter<AdapterCategoryAdminl21.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategoryl21> categoryArrayList;
    ArrayList<ModelCategoryl21> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminl21 filter;

    public AdapterCategoryAdminl21(Context context, ArrayList<ModelCategoryl21> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategoryl21 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivityl21.class);
    ...
    private void deleteCategory(ModelCategoryl21 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lab21");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminl21(filterList,this);
        }
        return filter;
    }
