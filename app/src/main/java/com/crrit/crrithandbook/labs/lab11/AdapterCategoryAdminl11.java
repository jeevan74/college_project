...
public class AdapterCategoryAdminl11 extends RecyclerView.Adapter<AdapterCategoryAdminl11.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategoryl11> categoryArrayList;
    ArrayList<ModelCategoryl11> filterList;

    private RowCategoryAdminBinding binding;

    //instance of filter class
    public FilterCategoryAdminl11 filter;

    public AdapterCategoryAdminl11(Context context, ArrayList<ModelCategoryl11> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategoryl11 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivityl11.class);
    ...
    private void deleteCategory(ModelCategoryl11 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Lab11");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdminl11(filterList,this);
        }
        return filter;
    }
