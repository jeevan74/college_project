...
import com.crrit.crrithandbook.databinding.ActivityPdfEditActivityl22Binding;
...
public class PdfEditActivityl22 extends AppCompatActivity {

    private ActivityPdfEditActivityl22Binding binding;
    public String expId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfEditActivityl22Binding.inflate(getLayoutInflater());
        ...
        refExp.child(expId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        DatabaseReference refExp = FirebaseDatabase.getInstance().getReference("Lab22");
        ...
        ref.child(expId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(PdfEditActivityl22.this, "Info Updated...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        progressDialog.dismiss();
                        Toast.makeText(PdfEditActivityl22.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
