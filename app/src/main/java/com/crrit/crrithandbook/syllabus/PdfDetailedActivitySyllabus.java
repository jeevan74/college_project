...
import com.crrit.crrithandbook.databinding.ActivityPdfDetailedSyllabusBinding;
...
public class PdfDetailedActivitySyllabus extends AppCompatActivity {

    private static final String TAG_DOWNLOAD = "DOWNLOAD_TAG";
    private ActivityPdfDetailedSyllabusBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfDetailedSyllabusBinding.inflate(getLayoutInflater());
        ...
        binding.rlclick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent1 = new Intent(PdfDetailedActivitySyllabus.this, PdfViewActivity.class);
        ...
        binding.downloadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(PdfDetailedActivitySyllabus.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
                    Log.d(TAG_DOWNLOAD, "onClick:Permission already granted can download pdf");
                    MyApplicationSyllabus.downloadPdf(PdfDetailedActivitySyllabus.this,""+expId,""+expTitle,""+expUrl);
                }
                else {
    ...
    private final ActivityResultLauncher<String> requestPermissionsLauncher =
            registerForActivityResult(new ActivityResultContracts.RequestPermission(), isGranted ->{
                if (isGranted){
                    ...
                    MyApplicationSyllabus.downloadPdf(
                            this,
                            ""+expId,
                            ""+expTitle,
                            ""+expUrl
        ...
        reference.child(expId)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        MyApplicationSyllabus.loadFromUrlSinglePage(""+expUrl,
                                ""+expTitle,
                                binding.pdfView,
                                binding.progressBar
                        );

                        MyApplicationSyllabus.loadSize(""+expUrl,
                                ""+expTitle,
                                binding.sizeTv
                        );
                        ...
                        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.N) {
                            date = MyApplicationSyllabus.formatTimestamp(Long.parseLong(timestamp));
                        }
