...
import com.crrit.crrithandbook.databinding.ActivityPdfAddSyllabusBinding;
...
public class PdfAddActivitySyllabus extends AppCompatActivity {

    private ActivityPdfAddSyllabusBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityPdfAddSyllabusBinding.inflate(getLayoutInflater());
    ...
    private void validateData() {
        ...
        if (TextUtils.isEmpty(title)){
            ...
            Toast.makeText(this, "Please select the Regulation...", Toast.LENGTH_SHORT).show();
        }
        else if (pdfuri==null){
        ...
        storageReference.putFile(pdfuri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(PdfAddActivitySyllabus.this, "PDF upload failed due to"+e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(PdfAddActivitySyllabus.this, "Successfully uploaded...", Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(PdfAddActivitySyllabus.this, "Failed to upload to db due to"+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
    }
