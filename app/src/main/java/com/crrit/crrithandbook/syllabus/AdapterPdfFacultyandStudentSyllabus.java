...
import com.crrit.crrithandbook.databinding.RowPdfFacultyAndStudentsyllabusBinding;
...
public class AdapterPdfFacultyandStudentSyllabus extends RecyclerView.Adapter<AdapterPdfFacultyandStudentSyllabus.HolderPdfAdmin>implements Filterable {//
    ...
    private RowPdfFacultyAndStudentsyllabusBinding binding;//vb
    ...
    public HolderPdfAdmin onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //binding
        binding = RowPdfFacultyAndStudentsyllabusBinding.inflate(LayoutInflater.from(context),parent,false);
...
//code is removed
    ...
    public Filter getFilter() {
        if (filter == null){
            filter = new FilterPdfFacultyandStudentSyllabus(filterlist,this);
        }
        return filter;
    }
