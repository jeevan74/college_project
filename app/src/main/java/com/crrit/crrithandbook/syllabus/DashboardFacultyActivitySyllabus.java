...
import com.crrit.crrithandbook.databinding.ActivityDashboardFacultySyllabusBinding;
...
public class DashboardFacultyActivitySyllabus extends AppCompatActivity {

    private FirebaseAuth firebaseAuth;
    private ActivityDashboardFacultySyllabusBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDashboardFacultySyllabusBinding.inflate(getLayoutInflater());
        ...
        binding.addCategoryBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DashboardFacultyActivitySyllabus.this, CategoryAddActivitySyllabus.class));
            }
        });
        ...
        binding.addPdfFab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(DashboardFacultyActivitySyllabus.this, PdfAddActivitySyllabus.class));
            }
        });
    ...
    private void loadCategories() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                //setup adapter
                adapterCategoryFacultyandStudentSyllabus = new AdapterCategoryFacultyandStudentSyllabus(DashboardFacultyActivitySyllabus.this,categoryArrayList);
