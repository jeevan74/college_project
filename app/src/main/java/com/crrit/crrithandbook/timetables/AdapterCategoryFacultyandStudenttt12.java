...
public class AdapterCategoryFacultyandStudenttt12 extends RecyclerView.Adapter<AdapterCategoryFacultyandStudenttt12.HolderCategory>implements Filterable {
    ...
    private FilterCategoryFacultyandStudenttt12 filter;

    public AdapterCategoryFacultyandStudenttt12(Context context, ArrayList<ModelCategorytt12> categoryArrayList) {
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorytt12 model = categoryArrayList1.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListFacultyandStudentActivitytt12.class);
    ...
    public Filter getFilter() {
        if (filter == null){
            filter = new FilterCategoryFacultyandStudenttt12(filterList,this);
        }
        return filter;
    }
