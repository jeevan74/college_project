...
public class AdapterCategoryAdmintt12 extends RecyclerView.Adapter<AdapterCategoryAdmintt12.HolderCategory> implements Filterable {

    public Context context;
    public ArrayList<ModelCategorytt12> categoryArrayList;
    ArrayList<ModelCategorytt12> filterList;

    private RowCategoryAdmintt12Binding binding;

    //instance of filter class
    public FilterCategoryAdmintt12 filter;

    public AdapterCategoryAdmintt12(Context context, ArrayList<ModelCategorytt12> categoryArrayList) {
    ...
    public HolderCategory onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //bind
        binding = RowCategoryAdmintt12Binding.inflate(LayoutInflater.from(context),parent,false);
    ...
    public void onBindViewHolder(@NonNull HolderCategory holder, int position) {
        //get data
        ModelCategorytt12 model = categoryArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, PdfListAdminActivitytt12.class);
    ...
    private void deleteCategory(ModelCategorytt12 model, HolderCategory holder) {
        //get the id
        String id = model.getId();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Timetable12");
        ref.child(id)
    ...
    public Filter getFilter() {
        if (filter==null){
            filter = new FilterCategoryAdmintt12(filterList,this);
        }
        return filter;
    }
