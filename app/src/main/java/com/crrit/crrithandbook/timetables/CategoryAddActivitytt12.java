...
import com.crrit.crrithandbook.databinding.ActivityCategoryAddTt12Binding;
...
public class CategoryAddActivitytt12 extends AppCompatActivity {
    private ActivityCategoryAddTt12Binding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCategoryAddTt12Binding.inflate(getLayoutInflater());
        ...
        ref.child(""+timestamp)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        ...
                        Toast.makeText(CategoryAddActivitytt12.this,"Lab Added Successfully",Toast.LENGTH_SHORT).show();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        //lab add failed
                        progressDialog.dismiss();
                        Toast.makeText(CategoryAddActivitytt12.this,""+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
